...
export const shared = defineConfig({
  ...
  head: [
    ...
    ['meta', { property: 'og:title', content: 'ETH100 | Together, Let’s Witness Ethereum Scaling 100×' }],
    ['meta', { property: 'og:site_name', content: 'ETH100' }],
    ['meta', { property: 'og:url', content: 'https://eth100.wtf/' }],
